...
* If you want to try popcorn-kernel, please go to the [wiki page](../../wiki) first. That wiki page should contain all the useful precedures for setting up popcorn with VMs.
